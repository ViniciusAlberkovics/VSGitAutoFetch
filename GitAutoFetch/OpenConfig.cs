...
namespace GitAutoFetch
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class OpenConfig
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("cea955db-8ff6-4187-bace-580312a3f1d3");
        ...
        private OpenConfig(AsyncPackage package, OleMenuCommandService commandService)
        {
